...
List setting_section_one = [
  {"icon": Icons.bookmark_outlined, "text": "Starred Messages", "color": Colors.yellow[700]},
  {
    "icon": Icons.laptop,
...
const List messageList = [
  ...
  {
    "messageId": "my_1",
    "senderId": "KUP2csE0BhRoqaGXFyo1xNLjKPA2",
    "receiverId": "10CfP4xhvLPcSzdb4EOPhbQ4lOM2",
    "text": """ مرحبا صديقي كيف حالك؟ 
    مرحبا صديقي كيف حالك؟""",
    "type": 0,
    "url": "",
