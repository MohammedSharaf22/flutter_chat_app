...
/// background.
///
/// The [padding] defaults to 16.0 pixels. When using a [MyCupertinoButton] within
...
///
/// {@tool dartpad}
/// This sample shows produces an enabled and disabled [MyCupertinoButton] and
...
class MyCupertinoButton extends StatefulWidget {
  ...
  /// default constructor.
  const MyCupertinoButton.filled({
    Key? key,
    required this.child,
    this.padding,
    this.disabledColor = CupertinoColors.quaternarySystemFill,
  ...
  ///
  /// Ignored if the [MyCupertinoButton] doesn't also have a [color].
  ///
  ...
  final VoidCallback? onLongPressedCancel;
...
class _MyCupertinoButtonState extends State<MyCupertinoButton> with SingleTickerProviderStateMixin {
  ...
  @override
  void didUpdateWidget(MyCupertinoButton old) {
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      ...
      onLongPressDown: enabled ? _handleLongPressDown : null,
      onLongPressUp: enabled ? _handleLongPressUp : null,
      onLongPressCancel: enabled ? _handleLongPressCancel : null,
