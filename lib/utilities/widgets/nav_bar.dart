...
const double _kNavBarPersistentHeight = 70.0;//kMinInteractiveDimensionCupertino;
...
/// to also has a [MyCupertinoNavigationBar] or a [CupertinoSliverNavigationBar]
...
///
/// By default, only one [MyCupertinoNavigationBar] or [CupertinoSliverNavigationBar]
...
class MyCupertinoNavigationBar extends StatefulWidget implements ObstructingPreferredSizeWidget {
  ...
  @override
  State<MyCupertinoNavigationBar> createState() => _MyCupertinoNavigationBarState();
}
...
/// `automaticallyImplyLeading` is true.
///
/// When manually inserted, the [MyCupertinoNavigationBarBackButton] should only
...
class MyCupertinoNavigationBarBackButton extends StatelessWidget {
  /// Construct a [MyCupertinoNavigationBarBackButton] that can be used to pop
  /// the current route.
  ///
