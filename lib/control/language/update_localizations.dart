...
Future updateLocalizationFile() async {
  //the document id for your google sheet 1Yjg-OM9HbBCbOXSdBwPy1MXDVQ8NoweEyaeW3Ag30Zs
  String documentId = "1yqdnRrQPZxUKezcQ1iZ8xkRSMzinNfI8rKHokMM4tHs";
  //String documentId = "1HeLoxJxD1deRRyDWQsP4963_4adxPAZLhDYP36dTyaY";
  //the sheetid of your google sheet
  String sheetId = "0";

  String _phraseKey = '';
  String filePathAndName = "lib/control/language/localization.g.dart";
...
class Localization extends Translations {
  ...
  try {
    //"https://docs.google.com/spreadsheets/d/1yqdnRrQPZxUKezcQ1iZ8xkRSMzinNfI8rKHokMM4tHs/edit?usp=sharing"
    final url =
    ...
    stdout.writeln('');
    stdout.writeln('---------------------------------------');
    stdout.writeln('Saving $filePathAndName');
    stdout.writeln('---------------------------------------');
