...
import 'package:flutter_chat_app/control/constants/globals_language.dart';
...
class LanguageController extends GetxController {
  ...
  setInitialLocalLanguage() {
    if (currentLanguageStore.value == '') {
      ...
      //print("ui.window.locale.toString()= ${ui.window.locale.toString()}");
...
// Gets current language stored
  RxString get currentLanguageStore {
    ...
    language.value = ui.window.locale.languageCode.toString();
    debugPrint("language= ${language.value}");
    return language;
  }
  ...
  Locale? get getLocale {
    if (currentLanguageStore.value == '') {
      var isExist = GlobalsLanguage.languageOptions
          .any((element) => Get.deviceLocale!.languageCode==element.key);
      if(isExist)
        language.value = Get.deviceLocale!.languageCode;
      else
        language.value = GlobalsLanguage.defaultLanguage;
